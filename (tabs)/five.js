  ...
  return (
    <ScrollView>
      ...
      <View style={styles.logoSection}>
        <Image source={require('./user.png')} style={styles.logoImage} />
        <View style={styles.logoTextContainer}>
          <Text style={styles.logoText}>Shri</Text>
          <Text style={styles.emailText}>shri01@gmail.com</Text>
        </View>
      </View>
    ...
    <ScrollView>
      {Array.from({ length: 5 }, (_, index) => (
        <View key={index} style={styles.billItem}>
          <Text style={styles.billText}>Bill {index + 1} to be paid</Text>
          <View>
            <Text style={styles.text1}>Text1 for Bill {index + 1}</Text>
            <Text style={styles.subtitle}>Subtitle for Bill {index + 1}</Text>
          </View>
        </View>
      ))}
    </ScrollView>
